...
@pytest.fixture
def admin_user():
    adminUser = UserModel(email="user4@dwellingly.org", password="1234", firstName="user4", lastName="admin", phone="555-867-5309", role=4, archived=0)
    return adminUser

@pytest.fixture
def new_user():
    newUser = UserModel(email="someone@domain.com", password="1234", firstName="user2", lastName="tester", phone="1-888-cal-saul", role=0, archived=0)
    return newUser

@pytest.fixture
def property_manager_user():
    return UserModel(email="manager@domain.com", password="1234", firstName="Leslie", lastName="Knope", phone="505-503-4455", role=2, archived=0)
