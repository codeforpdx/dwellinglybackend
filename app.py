...
from resources.user import AdminRegisterUser, UserRegister, User, UserLogin, ArchiveUser, UsersRole, UserAccessRefresh, UserRoles, Users
...
def create_routes(app):
    ...
    api.add_resource(AdminRegisterUser, 'user/add')
